...
public class ProfileData {
    ...
    public void setDepartment_job(String department_job) {
        this.department_job = department_job;
    }
    ...
    public void setNucleus_job(String nucleus_job) {
        this.nucleus_job = nucleus_job;
    }
